...
def format_phrase(phrase):
    """
    Format a phrase passed in as a sentence with a capital letter and full stop at the end
    >>> format_phrase("hello")
    'Hello.'
    ...
    'Byeee.'
    """
    phrase = phrase.strip() # remove white space
    if not phrase:
        return ""
    sentence = phrase[0].title() + phrase[1:].lower()
